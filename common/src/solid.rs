...
impl SolidLayer {
  pub fn get_coord(size: usize, solid_size: f32, x: usize, odd: bool) -> f32 {
    ...
    let shift = if odd { -solid_size * 0.5 } else { (-solid_size - scale) * 0.5 };
    ...
    if c0_inside {
        ...
        if c2_inside {
          ...
          if c3_inside {
            ...
            *p102 = *p012;
            ...
            // 01|23
            q(model, c0, e03, p031, c3, e13, p123, c1, e12, p012, c2, e02, p023);
        ...
        if c2_inside {
          if c3_inside {
            ...
            *p031 = *p301;
            ...
            // 02|13
            q(model, c0, e01, p012, c1, e21, p213, c2, e23, p230, c3, e03, p031);
          ...
          if c3_inside {
            // 03|12
            q(model, c0, e02, p023, c2, e32, p312, c3, e31, p031, c1, e01, p012);
      ...
      if c1_inside {
        if c2_inside {
          if c3_inside {
            ...
            *p201 = *p102;
            ...
            // 12|03
            q(model, c1, e13, p123, c3, e23, p230, c2, e20, p102, c0, e10, p130);
          ...
          if c3_inside {
            // 13|02
            q(model, c1, e10, p301, c0, e30, p320, c3, e32, p123, c2, e12, p102);
            *p130 = *p301;
            *p312 = *p123;
          } else {
            // 1|032
        ...
        if c2_inside {
          if c3_inside {
            // 23|01
            q(model, c2, e21, p213, c1, e31, p301, c3, e30, p230, c0, e20, p201);
